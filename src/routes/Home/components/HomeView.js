    ...
    return (
      <LoginRedirect>
        <DashboardLayout
          ...
          business={business}
        >
          <Row style={{textAlign: 'center', marginTop: '12px', marginBottom: '24px'}}>
            <Col xs={2}>
          ...
          <Row>
            <Col xs={8}>
              ...
              <Col xs={12} style={{height: '30px', backgroundColor: '#FEBF34', borderTopLeftRadius: '5px', borderTopRightRadius: '5px'}}>
